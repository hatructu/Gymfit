...
import { View, Text, TextInput, SafeAreaView,Image, StyleSheet,KeyboardAvoidingView, Alert, Button, TouchableOpacity, } from 'react-native';
...
export default class AddExercise extends Component{
    ...
    render() {
      ...
      return (
        <KeyboardAvoidingView style={AppStyles.appContainerRegister}>
          <SafeAreaView style={AppStyles.appContainerRegister}>
            ...
            <Text style={AppStyles.whiteText}>{Messages.addExercise.nameEx}</Text>
                    ...
                    <Image style={AppStyles.images}
                        source={this.state.image}
                    />
                    
                        <TouchableOpacity style={[AppStyles.button, {marginTop:AppSizes.paddingSml}]} onPress={this.onPressSave}>
                            <Text style={{color:AppColors.white, fontSize:AppSizes.paddingMedium}}>Lưu bài tập</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[AppStyles.button, {marginTop:AppSizes.paddingSml}]} onPress={this.onPressCancel}  >
                            <Text style={{color:AppColors.white, fontSize:AppSizes.paddingMedium}}>Huy</Text>
                        </TouchableOpacity>
